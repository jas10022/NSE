...
def getHistoryData(company, from_date=(datetime.today().strftime("%d-%m-%Y")), to_date=(datetime(datetime.today().year - 5, datetime.today().month,datetime.today().day).strftime("%d-%m-%Y"))):
